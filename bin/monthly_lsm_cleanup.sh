...
/home/svirskasr/workspace/ImagingEcosystem/bin/image_reconcile_directory.pl -path /groups/flylight/flylight/polarity/confocalStacks -write >>/tmp/monthly_lsm_cleanup.log
echo "Cleaning up MCFO LSMs" >> /tmp/monthly_lsm_cleanup.log
/home/svirskasr/workspace/ImagingEcosystem/bin/image_reconcile_directory.pl -path /groups/flylight/flylight/flip/confocalStacks -write >>/tmp/monthly_lsm_cleanup.log
